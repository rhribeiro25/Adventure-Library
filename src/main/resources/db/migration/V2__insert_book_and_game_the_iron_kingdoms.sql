DO $$
    ...
    BEGIN
        ...
        VALUES
            (v_book_id, v_category_fantasy),
            (v_book_id, v_category_medieval),
            (v_book_id, v_category_adventure)
        ON CONFLICT DO NOTHING;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'The king is dead. The throne room is silent, but every noble in the capital is already choosing a side.', 'BEGIN', NOW(), NOW())
        RETURNING id INTO v_section_1;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'The Council of Lords gathers under candlelight. Every word sounds polite, but every smile hides a dagger.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_20;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'At the Northern Wall, ancient horns echo across the snow. Something old has awakened beyond the ice.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_40;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'An assassin waits in the shadows of the royal corridor. The attack is sudden and precise.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_60;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'The Royal Treasury is nearly empty. Gold can buy loyalty, but only if you spend it wisely.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_80;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'War reaches the capital. Banners burn, soldiers fall, and the fate of the kingdom depends on your command.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_100;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'Inside the mountain, a sleeping dragon opens one golden eye. Power has a price.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_120;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'The Frozen Lands stretch endlessly before you. The dead do not rest here.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_140;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'You enter the Crown Room. The Iron Crown waits on the black stone throne.', 'NODE', NOW(), NOW())
        RETURNING id INTO v_section_160;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'You are forced into exile. The kingdom survives, but without you.', 'END', NOW(), NOW())
        RETURNING id INTO v_section_180;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'The kingdom bends the knee. Against betrayal, war and ancient darkness, you have claimed victory.', 'END', NOW(), NOW())
        RETURNING id INTO v_section_200;

        INSERT INTO sections (book_id, text, type, created_at, updated_at)
        VALUES (v_book_id, 'Your enemies win. At dawn, the executioner raises the axe.', 'END', NOW(), NOW())
        ...
        VALUES (v_option_id, 'LOSE_HEALTH', 3, 'The nobles resist. A hidden blade cuts your arm during the arrest.', NOW(), NOW());
        ...
        INSERT INTO consequences (option_id, type, value, text, created_at, updated_at)
        VALUES (v_option_id, 'LOSE_HEALTH', 4, 'The assassin wounds you before disappearing into the smoke.', NOW(), NOW());
        ...
        INSERT INTO consequences (option_id, type, value, text, created_at, updated_at)
        VALUES (v_option_id, 'LOSE_HEALTH', 5, 'You inspire your soldiers, but the battle nearly kills you.', NOW(), NOW());
        ...
        INSERT INTO consequences (option_id, type, value, text, created_at, updated_at)
        VALUES (v_option_id, 'GAIN_HEALTH', 5, 'The dragon accepts you. Ancient fire strengthens your spirit.', NOW(), NOW());
